...
<head>
    ...
    <title>Semua Produk Alfazza Shop</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="container">
            ...
            <input type="text" class="form-control form-control-lg search my-3" name="txtCountry" id="txtCountry" placeholder="Cari Barang Yang Anda Butuhkan" autocomplete="off">
            </form>
