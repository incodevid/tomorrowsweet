...
(2, 'Triastuti Prabasari', 'Perempuan', '-', '-', '-', 'Jl. Tingang XV Palangka Raya', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'alfazza1', '29janauari', 'Super');
...
--
ALTER TABLE `tb_detail_barang`
MODIFY `id_detail_barang` int(50) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
