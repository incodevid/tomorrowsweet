...
if ($cek>0){
   echo '<script>setTimeout(function() { 
        swal("Gagal Tersimpan! Detail Barang Sudah Ada", "Klik tombol dibawah untuk melanjutkan", "error").then(function() { 
    ...
    ?>
        ...
        <center><h3>Daftar Detail Produk</h3></center>
        ...
        <tbody>
            <?php 
                    $no = 1;
$query = mysqli_query($koneksi,"SELECT * FROM tb_detail_barang a INNER JOIN tb_barang b ON a.id_barang=b.id_barang ORDER BY id_detail_barang DESC");
...
?>
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-danger btn-xs"><i data-toggle="modal" data-target="#hapusDetail<?php echo $data['id_detail_barang']; ?>" class="material-icons">delete_forever</i></a> 
                </td>
            </tr>
        <?php $no++;  }  ?>
        </tbody>
...
$query1 = mysqli_query($koneksi,"SELECT * FROM tb_detail_barang a INNER JOIN tb_barang b ON a.id_barang=b.id_barang ORDER BY id_detail_barang DESC ");
while($data1  = mysqli_fetch_assoc($query1)){
?>

    <div class="modal fade" id="exampleModalCenter<?php echo $data1['id_detail_barang']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal fade" id="hapusDetail<?php echo $data1['id_detail_barang']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content shadow">
                <div class="modal-header">
                    <h5 class="header-title mb-0">Hapus Data Detail Produk</h5>
                </div>
                <div class="modal-body text-center pr-4 pl-4">
                    <figure class="avatar avatar-120 rounded-circle mt-0 border-0">
                        <img src="img/produk/<?php echo $data1['foto_barang']; ?>" alt="user image">
                    ...
                    <form class="was-validated" action="aksi/detail_produk/hapus_detail.php?id_detail_barang=<?php echo $data1['id_detail_barang']; ?>"  method="POST" enctype="multipart/form-data" >
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
