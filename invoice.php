...
if (empty($_SESSION['username']) AND empty($_SESSION['password'])) 
 {echo "<script>;document.location='login.php' </script> ";}
            ...
            $sqlk = mysqli_query($koneksi, "SELECT *,SUM(subtotal_beli) AS total FROM tb_orderan WHERE  kode_orderan='$kode_orderan' ");
    ...
    <div class="wrapper">
        <div class="header">
            <div class="row no-gutters">
                <div class="col-auto">
                    <a href="riwayat.php" class="btn  btn-link text-dark"><i class="material-icons">navigate_before</i></a>
                </div>
...
<tr>
<td class="title">
<a style="float:right;" href="cetak.php?kode_orderan=<?php echo $dataodr['kode_orderan']; ?>" target="_BLANK" class="btn  btn-link text-dark"><i class="material-icons">get_app</i></a>
...
<tr>
<td align="left" >
<?php echo $t['nama_akun']; ?><br>
<?php echo $t['nomor_hp']; ?><br>
<?php echo $t['email']; ?><br>
<?php echo $t['alamat']; ?><br>
<?php echo $t['nm_prov']; ?><br>
<?php echo $t['nm_kab']; ?><br>
<?php echo $t['kecamatan']; ?><br>
<?php echo $t['kelurahan']; ?> - <?php echo $t['kode_pos']; ?>
</td>
<td>
Owner Shop<br>
Benny Sarmoko<br>
